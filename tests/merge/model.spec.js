...
describe('merge/model', function() {
  ...
  describe('.merge', function() {
    ...
    lazy('ours', function() {
      return new Post(this.graphA, { title: 'A', desc: '1' });
    });
    lazy('ancestor', function() {
      return new Post(this.graphB, { title: 'A', desc: '1' });
    });
    lazy('theirs', function() {
      return new Post(this.graphC, { title: 'A', desc: '1' });
    });
    ...
    context('when one field changed in ours', function() {
      lazy('ours', function() {
        return new Post(this.graphA, { title: 'B', desc: '1' });
      });
    ...
    context('when one field changed in theirs', function() {
      lazy('theirs', function() {
        return new Post(this.graphC, { title: 'B', desc: '1' });
      });
    ...
    context('when same field changed in both', function() {
      ...
      lazy('theirs', function() {
        return new Post(this.graphC, { title: 'C', desc: '1' });
      });
    ...
    context('when separate field changed in both', function() {
      ...
      lazy('theirs', function() {
        return new Post(this.graphC, { title: 'A', desc: '2' });
      });
    ...
    context('when ours is unloaded', function() {
      lazy('ours', function() {
        return new Post(this.graphA, { desc: '1' });
      });
      lazy('ancestor', function() {
        return new Post(this.graphB, { desc: '1' });
      });
    ...
    context('when theirs is unloaded', function() {
      lazy('theirs', function() {
        return new Post(this.graphC, { desc: '2' });
      });
